...
const validateSignUp = (req, res, next) => {
 ...
 return middlewareFunction.checkField(req.body.phoneNumber, 'phone number', res);
  ...
  if (!req.body.password) {
    return middlewareFunction.checkField(req.body.password, 'password', res);
    ...
    console.log('i got here ish')
    
    return middlewareFunction.errorStatus(400, 'password not confirmed', res);
  }
  console.log('i got here =========')  
  return next();
};
